...
import { seedDemoSite } from '../dev/demo-tools.js';
import { hasOnlyMinorFlags, needsReview } from '../../../../shared/domain/flags.js';
import {
  CheckpointStatus,
  RoundResult,
  checkpointStatus,
  ...
  summarizeRound,
} from '../../../../shared/domain/rounds.js';
import { $, el } from '../../../../shared/lib/dom.js';
import { formatClock, formatDuration, formatLongDate, plural } from '../../../../shared/lib/format.js';
...
/** @typedef {import('../../../../shared/domain/rounds.js').NightSchedule} NightSchedule */
...
/** @param {import('../../../../shared/types.js').Report[]} reports */
...
/**
 * @param {LogEntry[]} entries
 * @param {import('../../../../shared/types.js').Checkpoint[]} checkpoints
