...
const id = {
  ...
  signIn: 'Masuk',
  signingIn: 'Memeriksa...',
  signInError: 'Email atau kata sandi salah. Periksa lagi, atau hubungi supervisor.',
  signInUnreachable: 'Server tidak bisa dihubungi. Periksa sinyal lalu coba lagi.',
  signOut: 'Keluar',
  ...
  qrIntro: 'Pilih titik yang mau dicetak, lalu tempel tiap label di lokasinya. Kode di bawah QR dipakai kalau kamera bermasalah.',
  ...
  importGuardsHint: 'Dua kolom: nama lengkap dan email. Baris judul boleh ada atau tidak.',
  ...
  passwordsOnce: 'Kata sandi ini hanya tampil sekali. Unduh atau catat sekarang, lalu berikan ke tiap petugas.',
...
const en: Record<Key, string> = {
  ...
  signIn: 'Sign in',
  signingIn: 'Checking...',
  signInError: 'Email or password is incorrect. Check them, or ask your supervisor.',
  signInUnreachable: 'Could not reach the server. Check the signal and try again.',
  signOut: 'Sign out',
  ...
  qrIntro: 'Select the checkpoints to print, then stick each label at its location. The code under the QR is for when the camera fails.',
  ...
  importGuardsHint: 'Two columns: full name and email. A header row is optional.',
  ...
  passwordsOnce: 'These passwords are shown only once. Download or write them down now, then give one to each guard.',
