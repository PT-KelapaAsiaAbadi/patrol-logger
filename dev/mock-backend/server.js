 ...
 */
import { AUTH, NETWORK_DELAY_MS, REPORTS, STORAGE_KEYS } from '../../shared/config.js';
import { Flag } from '../../shared/domain/flags.js';
import { sleep } from '../../shared/lib/async.js';
import { hashPin, randomSixDigits, randomToken, sha256Hex, verifySignature } from '../../shared/lib/crypto.js';
import { hasPosition } from '../../shared/lib/geo.js';
import { keyValueStore } from '../../shared/lib/storage.js';
import { checkAgainstHistory, checkLocation, checkTiming, parseCheckpointCode } from '../../shared/checks/checks.js';
import { appendLogEntry, verifyLogChain } from '../../shared/checks/log.js';
import { createEmptyState, loadState, saveState } from './state.js';

/** @typedef {import('../../shared/types.js').Guard} Guard */
/** @typedef {import('../../shared/types.js').Checkpoint} Checkpoint */
/** @typedef {import('../../shared/types.js').ScanDetails} ScanDetails */
/** @typedef {import('../../shared/types.js').ScanOutcome} ScanOutcome */
/** @typedef {import('../../shared/types.js').Report} Report */
...
/** @param {string} error @returns {import('../../shared/types.js').FailedResponse} */
const failure = (error) => ({ ok: false, error });

/** Emits a `reset` event when all data is cleared. */
class PatrolServer extends EventTarget {
  /** @type {import('../../shared/types.js').ServerState} */
   ...
   * @returns {Promise<import('../../shared/types.js').EnrollResponse>}
   */
  ...
  /** @param {Guard} guard @param {import('../../shared/types.js').EnrollmentCode} enrollment */
   ...
   * @returns {Promise<import('../../shared/types.js').ShiftResponse>}
   */
  ...
  async #followDeviceSequence(guard, request, body) {
    const device = /** @type {import('../../shared/types.js').EnrolledDevice} */ (guard.device);
  ...
  #collectFlags({ guard, scan, receivedAt }, checkpoint, flagsSoFar) {
    ...
    const position = /** @type {ScanDetails & import('../../shared/types.js').Position} */ (scan);
 ...
 * @param {import('../../shared/types.js').ServerConfig} options.config
