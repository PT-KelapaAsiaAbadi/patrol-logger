 ...
 */
import { needsReview } from '../domain/flags.js';
import { formatClock, pad2 } from '../lib/format.js';
...
/**
 * @param {import('../types.js').LogEntry[]} entries  One guard's scans, any order.
...
/** Flagged and rejected scans are longer and red. @param {import('../types.js').LogEntry} entry */
